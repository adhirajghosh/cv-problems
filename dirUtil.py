...
def joinWithSlash(list_):
    s = ''
    for l in list_:
        s = s + l +'/'
    return s[:-1]

def dirLoadImages(dir_, types = ['*.jpg', '*.JPEG'], size = 224, interp = 'bilinear'): 
...
def folder2feat(dir_, featType = 'resNet50', types = ['*.jpg', '*.JPG', '*.png', '*.JPEG' ], size = 224, interp = 'bilinear'):
